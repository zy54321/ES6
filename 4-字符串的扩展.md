...
1. [字符的 Unicode 表示法](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#%E5%AD%97%E7%AC%A6%E7%9A%84%20Unicode%20%E8%A1%A8%E7%A4%BA%E6%B3%95)
2. [codePointAt()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#codePointAt())
3. [String.fromCodePoint()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#String.fromCodePoint())
4. [字符串的遍历器接口](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#%E5%AD%97%E7%AC%A6%E4%B8%B2%E7%9A%84%E9%81%8D%E5%8E%86%E5%99%A8%E6%8E%A5%E5%8F%A3)
5. [normalize()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#normalize())
6. [includes(), startsWith(), endsWith()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#includes(),%20startsWith(),%20endsWith())
7. [repeat()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#repeat())
8. [padStart()，padEnd()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#padStart()%EF%BC%8CpadEnd())
9. [matchAll()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#matchAll())
10. [模板字符串](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#%E6%A8%A1%E6%9D%BF%E5%AD%97%E7%AC%A6%E4%B8%B2)
11. [实例：模板编译](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#%E5%AE%9E%E4%BE%8B%EF%BC%9A%E6%A8%A1%E6%9D%BF%E7%BC%96%E8%AF%91)
12. [标签模板](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#%E6%A0%87%E7%AD%BE%E6%A8%A1%E6%9D%BF)
13. [String.raw()](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#String.raw())
14. [模板字符串的限制](http://es6.ruanyifeng.com/?search=yield+&x=0&y=8#docs/string#%E6%A8%A1%E6%9D%BF%E5%AD%97%E7%AC%A6%E4%B8%B2%E7%9A%84%E9%99%90%E5%88%B6)
